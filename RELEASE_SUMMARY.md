...
Photo Sheet turns an iPad photo selection into composed US Letter sheets, ready for the native AirPrint interface. This initial release includes all five layouts, local crop/zoom/rotation, accessible ordering and removal, optional cut guides, and an offline-capable app shell.
...
- Chromium 153 and Playwright WebKit 26.6 pass all seven requested layout/count cases, EXIF orientation, rotation/zoom/pan, accessible cross-page ordering, deletion, reset, narrow/landscape layouts, 30-photo limits, resource cleanup and no external requests.
